...
- **`nki.collectives.allreduce` (SDK 2.30+)**: the one-line swap for `_mock_allreduce` in both the reduce-parallel path ([v0.10.0](https://trnsci.dev/blog/trntensor-v0100-the-test-surface-names-the-interface/)) and the mixed sharding path ([v0.12.0](https://trnsci.dev/blog/trntensor-v0120-the-last-notimplementederror--completing-the-sharding-contract/)).
